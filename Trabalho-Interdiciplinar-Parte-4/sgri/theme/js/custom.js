...
$(document).ready(function(){  
    ...
    $("#menu li a, #menu li ul li a, .wrapper .controlB ul li a, .logo a, ul li ul li a, .btnClickPage").click(function(event){
    ...
    if(aUrl[1] == "")
    {
        ...
        aUrl[1] = $("#menu .dash a").attr("href");
        window.location.hash = "#"+$("#menu .dash a").attr("href");
    }
    $().getUrl("../"+aUrl[1]);        
});
    ...
    $.fn.getUrl = function(aUrl) {
        ...
        $.post(aUrl, function(eData){
            ...
            $( div ).dialog({
                ...
                close: function(){
                    window.location.hash = "#"+$("#menu .dash a").attr("href");
                    $.post("../"+$("#menu .dash a").attr("href"), function(eData){
                        $(".conteudo").html(eData);
                        $(".bloqueador, .loading").css({
                            "display":"none"
                        });
