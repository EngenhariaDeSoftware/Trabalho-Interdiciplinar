...
<div class="widget">
    <div class="title"><img src="../theme/images/icons/dark/full2.png" alt="" class="titleIcon" /><h6>Lista de Suas Reservas Ativas</h6></div>                          
        ...
        <tbody>
            <?php foreach ($reservas as $valor): ?>
                <tr class="gradeC">
                    ...
                    <td class="actBtns">
                        <a href="<?php echo $valor->idReserva; ?>" id="reserva/cancelar/" title="Cancelar Reserva" class="tipS deletar">
