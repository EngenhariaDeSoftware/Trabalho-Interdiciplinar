...
<form action="reservaevento/gerarRelatorioReservasEventos" id="validate" class="formRelatorio" method="POST">
    <fieldset>
        <div class="widget">
            <div class="title"><img src="../theme/images/icons/dark/list.png" alt="" class="titleIcon" /><h6>Relatorios Eventos</h6></div>
            <div class="formRow">
                <label>Desejo Gerar um Relatório de Tudox:</label>
                <div class="formRight">
