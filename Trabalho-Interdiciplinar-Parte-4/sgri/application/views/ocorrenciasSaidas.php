...
<div class="widget">
    ...
    <div class="title"><img src="../theme/images/icons/dark/full2.png" alt="" class="titleIcon" /><h6>Ocorrências Enviadas</h6></div>                          
    <table cellpadding="0" cellspacing="0" border="0" class="display dTable">
        <thead>
            <tr>
                <th>Descrição</th>
                <th>Data</th>
                <th>Eu Enviei Para</th>
                <td>Ações</td>
            </tr>
        </thead>
        <tbody>
